            ...
            if (!SharedPreferencesProvider(requireContext()).getUserStatus()){
                ...
                when(value){
                    "EGP"-> {cartFragmentBinding.textTotalprice.text=totalCalc(product).toString()+" "+getString(R.string.eg)
                        ...
                        cartFragmentBinding.tvSubTotal.text=totalCalc(product).toString()+" "+getString(R.string.eg)
                    ...
                    "USA"-> {
                        ...
                        cartFragmentBinding.tvSubTotal.text= number.toString() + " " + getString(R.string.us)
                    ...
                    "EUR"->      {
                        ...
                        cartFragmentBinding.tvSubTotal.text=number.toString()+" "+getString(R.string.eur)
                    }
                    else-> {
